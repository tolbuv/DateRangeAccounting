...
using DateRangeAccounting.API.Providers;
using DateRangeAccounting.API.Results;
...
namespace DateRangeAccounting.API.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<ManageInfoViewModel> GetManageInfo(string returnUrl, bool generateState = false)
        {
            ...
            List<UserLoginInfoViewModel> logins = user.Logins
                .Select(linkedAccount 
                    => new UserLoginInfoViewModel {LoginProvider = linkedAccount.LoginProvider, ProviderKey = linkedAccount.ProviderKey})
                .ToList();
